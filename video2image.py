...
def parse_args():
    ...
    parser.add_argument('--video-path', type=str, default='./data/video.mkv')
    parser.add_argument('--save-path', type=str, default='./data/acane')
    parser.add_argument('--max-image', type=int, default=10000)
